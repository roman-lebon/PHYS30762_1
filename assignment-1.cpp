// assignment-1.cpp
// PHYS30762 Assignment 1 – The Bohr Atom
// Roman le Bon - 11423027

// Include libraries needed for input, output, and strings
...
int main() {
  ...
  while (restart == 'y') {
    ...
    while (!valid_input) {
        ...
        if (input_stream >> additional_characters) { // Check if there are any additional characters included after the four that should be input
            std::cout << "Invalid input format. Too many values provided. Please try again: ";
        continue;
        }
